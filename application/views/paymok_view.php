...
<html lang="en">
  ...
  <div class="container my-5">
        <div class="p-5 text-center bg-body-tertiary rounded-3">
            ...
            <a href="https://mdarc-dev.jlkconsulting.info" class="btn btn-outline-secondary"> Go back to MDARC Membership Portal </a>
        </div>
    </div>
    <div class="container my-5">
      <div class="row">
      ...
      <div class="row mt-3">
            <div class="col-lg-8 offset-lg-2">
              ...
              -------------------------------------------------------------------<br />
              <strong>Total amount paid: <?php echo '$' . number_format($total, 2, '.', ','); ?></strong>
            </div>
      </div>
    </div>
  </body>
